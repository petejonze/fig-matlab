...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% (E6) Different sized panels / shifting one panel
%%%     #####
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
...
set(gca, 'Position', get(gca,'Position').*[1 1.35 1 1])
    ...
    isTight     = true;
    isSquare    = true;
    hFig        = fig_make(figDim, nPlots, isTight, isSquare, [],[], 'YTickL','All');

    % nudge the rightmost panel right
    set(fig_subplot(3), 'Position', get(gca, 'Position')+[.11 0 0 0]);
    % nudge all panels left
    set(fig_subplot(1), 'Position', get(gca, 'Position')-[.1 0 0 0]);
    set(fig_subplot(2), 'Position', get(gca, 'Position')-[.1 0 0 0]);
    set(fig_subplot(3), 'Position', get(gca, 'Position')-[.1 0 0 0]);
    ...
    % stretch leftmost panels
    set(fig_subplot(1, 1), 'Position', get(gca, 'Position')+[-.35 0 0.35 0]);
    set(fig_subplot(2, 1), 'Position', get(gca, 'Position')+[-.35 0 0.35 0]);
    
    % nudge the rightmost panel right and increase height
    set(fig_subplot(2, 2), 'Position', get(gca, 'Position').*[1 1 1 2]+[.1 0 .05 0]);
    
    % remove extra panel
    delete(fig_subplot(1, 2));
