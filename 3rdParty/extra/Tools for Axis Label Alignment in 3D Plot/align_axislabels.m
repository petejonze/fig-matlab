...
%
% Example 1: % set ActionPostCallback to align_axislabels
%  h = rotate3d;
%  set(h,'ActionPostCallback',@align_axislabels);
%
% Example 2: % set WindowButtonMotionFcn to align_axislabels
%  h = rotate3d;
%  set(h,'ActionPreCallback',...
%      'set(gcf,''windowbuttonmotionfcn'',@align_axislabels)')
